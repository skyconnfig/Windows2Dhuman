...
var createQtAppInstance2 = ( () => {
    ...
    return (function(createQtAppInstance) {
        ...
        Module2 = typeof createQtAppInstance != "undefined" ? createQtAppInstance : {};
        ...
        var _processImage = Module2["_processImage"] = function() {
            return (_processImage = Module2["_processImage"] = Module2["asm"]["processImage"]).apply(null, arguments)
        }
        ;
        var _processJson = Module2["_processJson"] = function() {
            return (_processJson = Module2["_processJson"] = Module2["asm"]["processJson"]).apply(null, arguments)
        }
        ;
        var _setRefData = Module2["_setRefData"] = function() {
            return (_setRefData = Module2["_setRefData"] = Module2["asm"]["setRefData"]).apply(null, arguments)
        }
        ;
        var _setAudioBuffer = Module2["_setAudioBuffer"] = function() {
            return (_setAudioBuffer = Module2["_setAudioBuffer"] = Module2["asm"]["setAudioBuffer"]).apply(null, arguments)
        }
        ;
        var _updateBlendShape = Module2["_updateBlendShape"] = function() {
            return (_updateBlendShape = Module2["_updateBlendShape"] = Module2["asm"]["updateBlendShape"]).apply(null, arguments)
        }
        ;
...
if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports["createQtAppInstance"] = createQtAppInstance2;
